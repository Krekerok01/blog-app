...
public class PostLikeController {
    ...
    @PostMapping("/{postId}")
    public ResponseEntity<Boolean> likeOrDislikePost(@PathVariable Long postId, @RequestParam Long appUserId) {
        return new ResponseEntity<>(postLikeService.likeOrDislikePost(appUserId, postId), HttpStatus.OK);
    }
